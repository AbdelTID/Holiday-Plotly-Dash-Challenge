...
models_dict = {
    "Logistic":LogisticRegression(max_iter=1000),'Random Forest':RandomForestClassifier(random_state=42,max_depth=6),"XGB":XGBClassifier(random_state=42,max_depth=6),
